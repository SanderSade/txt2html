...
namespace text2html.test
{
	...
	public class ConsoleAppTest
	{
		private static void Write(object displayObject)
		{
			...
			{
				ContractResolver = new InternalFieldResolver(),
		...
		{
			Program.Main("t8.shakespeare.txt", "-t:\"Collected works\"", "-bold", "italic", "/urls", "entities", "-fixparagraphs:60",
				"o:shakespeare.complex.html");
